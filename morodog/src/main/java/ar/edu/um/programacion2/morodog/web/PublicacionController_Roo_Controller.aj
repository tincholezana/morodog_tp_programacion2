...
privileged aspect PublicacionController_Roo_Controller {
    ...
    @Autowired
    UsuarioService PublicacionController.usuarioService;
    
    @Autowired
    PublicacionService PublicacionController.publicacionService;
    
    @Autowired
    LinkService PublicacionController.linkService;
    
    @Autowired
    RePublicacionService PublicacionController.rePublicacionService;
    
    @Autowired
    TendenciaService PublicacionController.tendenciaService;
    ...
    void PublicacionController.populateEditForm(Model uiModel, Publicacion publicacion) {
        ...
        uiModel.addAttribute("tendencias", tendenciaService.findAllTendencias());
