...
import ar.edu.um.programacion2.morodog.domain.ConfiguracionDataOnDemand;
...
privileged aspect ConfiguracionDataOnDemand_Roo_DataOnDemand {
    ...
    public Configuracion ConfiguracionDataOnDemand.getNewTransientConfiguracion(int index) {
        ...
        setNDiasEmail(obj, index);
        setNDiasTendencia(obj, index);
        return obj;
    }
    
    public void ConfiguracionDataOnDemand.setNDiasEmail(Configuracion obj, int index) {
        int nDiasEmail = index;
        obj.setNDiasEmail(nDiasEmail);
    }
    
    public void ConfiguracionDataOnDemand.setNDiasTendencia(Configuracion obj, int index) {
        int nDiasTendencia = index;
        obj.setNDiasTendencia(nDiasTendencia);
    }
