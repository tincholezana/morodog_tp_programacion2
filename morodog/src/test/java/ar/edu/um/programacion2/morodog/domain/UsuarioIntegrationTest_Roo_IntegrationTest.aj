...
import ar.edu.um.programacion2.morodog.domain.UsuarioIntegrationTest;
...
privileged aspect UsuarioIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    UsuarioService UsuarioIntegrationTest.usuarioService;
    
    @Test
    public void UsuarioIntegrationTest.testCountAllUsuarios() {
    ...
    @Test
    public void UsuarioIntegrationTest.testUpdateUsuarioUpdate() {
        Usuario obj = dod.getRandomUsuario();
        Assert.assertNotNull("Data on demand for 'Usuario' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Usuario' failed to provide an identifier", id);
    ...
    @Test
    public void UsuarioIntegrationTest.testSaveUsuario() {
        Assert.assertNotNull("Data on demand for 'Usuario' failed to initialize correctly", dod.getRandomUsuario());
    ...
    @Test
    public void UsuarioIntegrationTest.testDeleteUsuario() {
        Usuario obj = dod.getRandomUsuario();
        Assert.assertNotNull("Data on demand for 'Usuario' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Usuario' failed to provide an identifier", id);
